...
//   }
// }
  // console.log('These names are  in both list=>')
//  var mobil = [ "Qmobil" ,"nokia", "Realme","Readme","Iphone","Samsung","vivo"]
//  var students1 = ["Ahmed", "Abdul", "Bilal", "Raza", "Haris", "Shoab"];
//  var userPrizeBond = [234, 235, 236, 237, 238, 323, 21, 313, 434, 124, 360];
 
//  for(var i = 0; i = students1.length; i++){console.log(students1)}
// alert("hello world")
// prompt("inut your value"